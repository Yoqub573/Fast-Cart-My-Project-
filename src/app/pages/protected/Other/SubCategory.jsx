		...
		<div className='flex flex-col md:flex-row items-start gap-[40px]'>
			<div className='flex flex-col w-[100%] md:w-[42.1%]'>
				<div className='border-b-2 border-b-[#E6E9F4] flex justify-between py-[16px]'>
					<p className='text-[#5A607F] text-[16px] font-[400]'>Sub-Categories</p>
				...
				{data?.data?.map(e => {
					return (
						<div key={e.id} className='w-[100%] flex py-[16px] hover:bg-gray-50 border-b border-b-[#E6E9F4] justify-between items-center'>
			...
			<div className={`w-[100%] md:w-[53.79%] p-[28px] border border-[#E5E5E5] rounded-[4px] ${!edit ? "flex" : "hidden"} flex-col gap-[24px]`}>
				<p className='text-[#131523] text-[20px] font-[700]'>Add new Sub-category</p>
				<TextField
					value={name}
				...
				<button
					onClick={() => {
						addSubCategory({ name: name, id: idx })
						setName('')
						setIdx('')
						refetch()
					}}
			...
			<div className={`w-[100%] md:w-[53.79%] p-[28px] border border-[#E5E5E5] rounded-[4px] ${edit ? "flex" : "hidden"} flex-col gap-[24px]`}>
				<p className='text-[#131523] text-[20px] font-[700]'>Edit Sub-category</p>
				<TextField
					value={editname}
				...
				<button
					onClick={() => {
						editSubCategory({ name: editname, id: id,catId:idx2 })
						setEditName('')
						setIdx('')
						refetch()
					}}
